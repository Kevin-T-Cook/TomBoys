  ...
  return (
    <div className="relative w-full">
      <button
        ...
        className={`w-full border border-gray-300 shadow-sm px-4 py-2 rounded-md text-left flex justify-between items-center bg-white ${guestsAdded ? 'text-lg' : 'text-lg'}`}
      >
        <div className="flex items-center">
          <svg
            ...
            height="20" 
            fill="currentColor"
            className={`bi bi-people-fill ${guestsAdded ? 'text-gray-500 text-xs' : 'text-gray-500'}`}
            viewBox="0 0 16 16"
          >
